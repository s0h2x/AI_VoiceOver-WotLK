...
function SoundQueueUI:InitDisplay()
    ...
    self.frame.container.stopGossip:HookScript("OnClick", function()
        PlaySound(SOUNDKIT_SFX.U_CHAT_SCROLL_BUTTON)
...
function SoundQueueUI:InitPortrait()
	...
	self.frame.portrait.model:SetModelAnimation(self.frame.portrait.model.animation, true)
